...
void acceptdata()
{
    ...
    cin>>s.arc;
    cout<<"ENTER YOUR IOT MARK :";
    cin>>s.writing;
    cout<<"ENTER YOUR ELN MARK :";
    cin>>s.alg;
...
void viewall()
{
    ...
    while(infile.read(reinterpret_cast<char*>(&s),sizeof(student)))
    {
        ...
        cout<<"\t\t\t\tSTUDENT ID NUMBER :USN/"<<s.id<<endl<<endl;
        cout<<"\t\t\t\tSTUDENT ROLL NUMBER :"<<s.roll<<endl<<endl;
        cout<<"\t\t\t\tPHYSICS :"<<s.pro<<endl<<endl;
        cout<<"\t\t\t\tMATHS :"<<s.arc<<endl<<endl;
        cout<<"\t\t\t\tIOT :"<<s.writing<<endl<<endl;
        cout<<"\t\t\t\tELN :"<<s.alg<<endl<<endl;
...
void view_Specific(int n)
{
    ...
    while(infile.read(reinterpret_cast<char*>(&s),sizeof(student)))
    {
        ...
        cout<<"\t\t\t\tSTUDENT ID NUMBER :USN/"<<s.id<<endl;
        cout<<"\t\t\t\tSTUDENT ROLL NUMBER :"<<s.roll<<endl;
        cout<<"\t\t\t\tPHYSICS  :"<<s.pro<<endl;
        cout<<"\t\t\t\tMATHS :"<<s.arc<<endl;
        cout<<"\t\t\t\tIOT :"<<s.writing<<endl;
        cout<<"\t\t\t\tELN :"<<s.alg<<endl;
        cout<<"\t\t\t\tSUM :"<<s.sum<<endl;
